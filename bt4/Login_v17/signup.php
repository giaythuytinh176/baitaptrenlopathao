...
<div class="signup-form">
    ...
    if (!empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['confirm_password'])) {
        ...
        if ($_POST['password'] != $_POST['confirm_password']) {
            $error = true;
            $mess = "Your password and confirmation password do not match.";
        }
...
//        }
    ...
    <div class="text-center">Already have an account? <a id="page-signin" href="#">Login here</a></div>
</div>
</body>

<script>
    document.getElementById('page-signin').href = document.URL.replace("signup.php", "index.php");
</script>
</html>